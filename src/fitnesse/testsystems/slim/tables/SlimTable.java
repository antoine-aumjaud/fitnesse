...
public abstract class SlimTable {
  ...
  protected Instruction callAndAssign(List<String> symbolNames, String instanceName, String functionName, Object... args) {
    return new CallAndAssignInstruction(makeInstructionTag(), symbolNames, instanceName, Disgracer.disgraceMethodName(functionName), args);
  }
